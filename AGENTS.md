...
Tools exposed: `audit_file`, `audit_text`, `audit_file_v2` (supports `claim_extractor`, `evidence_mode`, `max_claims`, and `source_pack`), `summarize_artifacts`, `summarize_trace`, and `install_snippet`.
